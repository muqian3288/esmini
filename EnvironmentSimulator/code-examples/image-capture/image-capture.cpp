...
int main(int argc, char* argv[])
{
	...
	SE_Init("../resources/xosc/cut-in_simple.xosc", 0, 3, 0, 0);  // 3 = offscreen + capture-to-file (no viewer window)
	...
	SE_Init("../resources/xosc/lane_change_crest.xosc", 0, 2, 0, 0);  // 2 = offscreen only (no viewer window)
